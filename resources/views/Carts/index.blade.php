                ...
                <div class="card shadow-lg border-0 rounded-4">
                    <div class="card-body">
                            ...
                            <li class="list-group-item d-flex justify-content-between align-items-center bg-light mb-2 rounded">
                                <div class="d-flex align-items-center">
                                    ...
                                    <a href="{{ route('courses.show', $course) }}"
                                        class="fw-semibold text-decoration-none text-primary">{{ $course->course_name }}</a>
                                </div>
                                <span class="badge bg-success fs-6 px-3 py-2">{{ $course->Price() }}</span>
                                <a  href="{{route('removeFromCart',$course)}}" class="btn btn-danger btn-sm d-flex align-items-center" title="Remove">
                        ...
                        <div class="d-flex justify-content-between align-items-center border-top pt-3">
                            ...
                            <a href="{{route('checkout.index')}}" class="btn btn-primary btn-lg px-4 shadow-sm">
